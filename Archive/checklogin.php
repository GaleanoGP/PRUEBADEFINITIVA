      ...
      <!--En esta parte , crearemos una segunda sección superior en la web. -->
		...
		<section class="shop login section">
			<div class="container">
              ...
              <!--En este archivo vamos a comprobar que el correo y la contraseña introducidas en login.html  -->
              <?php
              //incluyo el archivo de conexion con la base de datos
              include_once 'conexion.php';
              $conexion = new mysqli($host_db, $user_db, $pass_db, $db_name);
              // reporto un error si hay fallo de conexión con la bbdd
              if ($conexion->connect_error) {
               die("La conexion falló: " . $conexion->connect_error);
              }
              $email = $_POST['correo'];
              $password = $_POST['password'];
              // aquí compruebo que el usuario y la contraseña coincidan
              $sql = "SELECT * FROM $tbl_name WHERE correo = '$email'";
              ...
              if ($password==$row['password']) {
                  ...
                  echo "Bienvenid@! " . $_SESSION['correo'];
                  echo "<br><br><a href=panel-control.php>Mi cuenta</a>";
               } else {
