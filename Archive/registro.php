				...
				<div class="row">
					<div class="col-lg-6 offset-lg-3 col-12">
						<div class="login-form">
							<h2>Registro</h2>
							<!-- Form para el registro de usuarios, en todos los campos empleamos el atributo requiered , para indicar al usuario que es necesario rellenar todos los datos.-->
							<form class="form" method="post" action="registrar-usuario.php">
								<div class="row">
									<div class="col-12">
                      ...
                      <!--Input para introducir el nombre. -->
									...
									<div class="col-12">
										<div class="form-group">
                      <!--Input para introducir los apellidos. -->
                  ...
                  <div class="col-12">
										<div class="form-group">
                      <!--Input para introducir el correo. -->
                  ...
                  <div class="col-12">
                    <div class="form-group">
                      <!--Input para introducir la dirección. -->
                  ...
                  <div class="col-12">
                    <div class="form-group">
                      <!--Input para introducir la segunda parte de la dirección , piso portal , etc. -->
                      <label>Dirección 2<span>*</span></label>
                      <input type="text" name="direccion2" placeholder="" required>
                    </div>
                  </div>
                  ...
                  <div class="col-12">
                    <div class="form-group">
                      ...
                      <!--Input para introducir la ciudad. -->
                  ...
                  <div class="col-12">
                    <div class="form-group">
                      ...
                      <!--Input para introducir el código postal. -->
                      <input type="number"  name="cp" placeholder="" required >
                    </div>
                  </div>
                  ...
                  <div class="col-12">
                    <div class="form-group">
                      ...
                      <!--Input para introducir la provincia. -->
                      <input type="text" name="provincia" placeholder="" required>
                    </div>
                  </div>
									<div class="col-12">
										<div class="form-group">
											<label>Contraseña<span>*</span></label>
                      <!--Input para introducir la contraseña , indicamos tipo contraseña para que los caracteres no se muestren y aparezcan como puntos , por seguridad. -->
