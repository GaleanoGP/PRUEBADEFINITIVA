                ...
                <body>
                  <div style="width:700px; margin:50 auto;">
                    ...
                    if(!empty($_SESSION["shopping_cart"])) {
                      ...
                      <div class="cart_div">
                        <a href="cart.php">
                          <img src="images/cart-icon.png" /> Carrito.
                      ...
                      <!--Creamos el botón en el que cuando pulsemos guardaremos el pedido en la base de datos. -->
                      <form class="form" method="post" action="finalizarpedido.php">
                        <div class="col-12">
                          <div class="form-group button">
                            <button type="submit" class="btn ">Tramitar Pedido</button>
                          </div>
                            <?php if(isset($_SESSION["shopping_cart"])):?>
                                <?php foreach ($_SESSION["shopping_cart"] as $product){ ?>
                                    <input type="hidden" name="name[]" value="<?php echo $product["name"]; ?>">	<br />
                                    <input type="hidden" name="cantidad[]" value="<?php echo $product["quantity"]; ?>">	<br />
                                    <input type="hidden" name="precio[]" value="<?php echo $product["price"]; ?>">	<br />
