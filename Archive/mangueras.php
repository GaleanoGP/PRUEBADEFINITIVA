      ...
      <div class="container">
          ...
          <div class="col-12">
            <div class="bread-inner">
              <ul class="bread-list">
                ...
                <li><a href="index.php">Productos<i class="ti-arrow-right"></i></a></li>
                <li class="active"><a href="mangueras.php">Magueras</a></li>
              </ul>
            </div>
          </div>
        </div>
		...
		<section class="shop login section">
			<div class="container">
              ...
              // hago una consulta a la base de datos de todos los productos que sean de tipo "manguera", ya que nos encontramos en la página sobre este tipo de productos.

              $result = mysqli_query($con,"SELECT * FROM `productos` WHERE tipo='manguera'");
